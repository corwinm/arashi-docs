...
`handoff` supports standalone mode and reports the main repository, caller worktree, and workspace mode in Markdown or JSON. See the [Use Arashi in One Repository](/getting-started/standalone/).
