...
`status` supports standalone repositories and reports standalone mode and exact paths in human or JSON output. See the [Use Arashi in One Repository](/getting-started/standalone/).
