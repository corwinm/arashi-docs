...
- Use `arashi-arashi` for issues, OpenSpec proposals, workspace coordination, and cross-repo context.
- Use `arashi` for the CLI and workspace-management behavior.
- Use `arashi-docs` for this documentation site.
- Use `arashi-skills` and `arashi-vscode` for their project-specific changes.
