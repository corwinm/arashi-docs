...
hero:
  ...
  image:
    html: |
      <div class="hero-media-shell" role="presentation">
        <div class="hero-media-frame">
          <svg class="hero-media-svg" viewBox="0 0 360 320" width="360" height="320" preserveAspectRatio="xMidYMid meet" role="img" aria-label="Neon signal grid" xmlns="http://www.w3.org/2000/svg">
            <defs>
